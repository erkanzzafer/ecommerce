                ...
                <div class="row">
                        ...
                        <div class="tab-content" id="v-pills-tabContent" id="sticky_sidebar">
                            ...
                            <div class="tab-pane fade show active" id="v-pills-paypal" role="tabpanel"
                                ...
                                <div class="row">
                                    <div class="col-xl-12 m-auto">
                                        <div class="wsus__payment_area">
                                            <a class="nav-link common_btn text-center" href="{{ route('user.paypal.payment') }}"> PayPAl ile Öde </a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-xl-12 m-auto">
                                    <div class="wsus__payment_area">
                                        <button class="nav-link common_btn"> Stripe ile Öde  </button>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-4 col-lg-4">
                        <div class="wsus__pay_booking_summary" id="sticky_sidebar2">
                            <h5>Sipariş Özeti</h5>
                            <p>Ürün Toplam: <span>{{ $settings->currency_icon }}{{ getCartTotal() }}</span></p>
                            <p>Kargo Ücreti(+): <span>{{ $settings->currency_icon }}{{ getShippingFee() }} </span></p>
                            <p>Kupon(-): <span>{{ $settings->currency_icon }}{{ getCartDiscount() }} </span></p>
                            <h6>Toplam: <span>{{ $settings->currency_icon }}{{ getFinalPayableAmount() }} </span></h6>
                        </div>
                    </div>
                </div>
            </div>
