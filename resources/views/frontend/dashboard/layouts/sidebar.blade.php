<div class="dashboard_sidebar">
    ...
    <ul class="dashboard_link">
        <li><a class="active" href="{{ route('user.dashboarduser') }}"><i class="fas fa-tachometer"></i>Dashboard</a>
        </li>
        @if (auth()->user()->role == 'vendor')
            <li><a class="" href="{{ route('vendor.dashboard') }}"><i class="fas fa-tachometer"></i>Mağaza
                    Paneli</a></li>
        @endif
        ...
        @if (auth()->user()->role == 'user')
            <li><a href="{{ route('user.vendor-request.index') }}"><i class="far fa-user"></i> Mağaza Talebi</a></li>
        @endif
