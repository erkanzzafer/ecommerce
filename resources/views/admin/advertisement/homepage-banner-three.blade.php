    ...
    <div class="card border">
        <div class="card-body">
            <form action="{{ route('admin.homepage-banner-section-three') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <img src="{{ asset(@$homepage_section_banner_three->banner_one->banner_one_image) }}" width="150px" alt="">
                </div>
                <div class="form-group">
                    <label for="">Banner Resim</label>
                    <input type="file" class="form-control" name="banner_one_image" value="">
                    <input type="hidden" value="{{ @$homepage_section_banner_three->banner_one->banner_one_image }}" name="banner_one_old_image" id="">
                </div>
                ...
                <div class="form-group">
                    <img src="{{ asset(@$homepage_section_banner_three->banner_two->banner_two_image) }}" width="150px" alt="">
                </div>
                <div class="form-group">
                    <label for="">Banner Resim</label>
                    <input type="file" class="form-control" name="banner_two_image" value="">
                    <input type="hidden" value="{{ @$homepage_section_banner_three->banner_two->banner_two_image }}" name="banner_two_old_image" id="">
                </div>
                ...
                <div class="form-group">
                    <img src="{{ asset(@$homepage_section_banner_three->banner_three->banner_three_image) }}" width="150px" alt="">
                </div>
                <div class="form-group">
                    <label for="">Banner Resim</label>
                    <input type="file" class="form-control" name="banner_three_image" value="">
                    <input type="hidden" value="{{ @$homepage_section_banner_three->banner_three->banner_three_image }}" name="banner_three_old_image" id="">
                </div>
