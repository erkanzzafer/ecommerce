                        ...
                        <div class="form-group">
                            ...
                            <select name="sub_cat_one" class="form-control sub-category">
                                ...
                                @foreach ($subCategories as $subCategory)
                                    <option {{ $subCategory->id == $sliderSectionThree[0]->sub_category ? 'selected' : '' }}
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select name="child_cat_one" class="form-control child-category">
                                ...
                                <option
                                    {{ $childCategory->id == $sliderSectionThree[0]->sub_category ? 'selected' : '' }}
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select name="sub_cat_two" class="form-control sub-category">
                                <option value="">Seçiniz</option>
                                @foreach ($subCategories as $subCategory)
                                    <option {{ $subCategory->id == $sliderSectionThree[1]->sub_category ? 'selected' : '' }}
                                        value="{{ $subCategory->id }}">{{ $subCategory->name }}</option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select name="child_cat_two" class="form-control child-category">
                                ...
                                @foreach ($childCategories as $childCategory)
                                <option
                                    {{ $childCategory->id == $sliderSectionThree[1]->sub_category ? 'selected' : '' }}
                                    value="{{ $childCategory->id }}">{{ $childCategory->name }}</option>
                            @endforeach
                            </select>
                        </div>
